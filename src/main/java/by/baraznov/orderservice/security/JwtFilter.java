...
import by.baraznov.orderservice.util.jwt.JwtExpiredException;
import by.baraznov.orderservice.util.jwt.JwtMalformedException;
import by.baraznov.orderservice.util.jwt.JwtSignatureException;
import by.baraznov.orderservice.util.jwt.JwtValidationException;
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse,
        ...
        try {
            ...
            if (token != null && jwtProvider.validateAccessToken(token)) {
                ...
                JwtAuthentication jwtInfoToken = JwtUtils.generate(claims, token);
