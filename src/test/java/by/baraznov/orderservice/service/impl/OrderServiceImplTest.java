...
class OrderServiceImplTest {
    ...
    void test_getOrderById() {
        ...
        UserGetDTO userGetDTO = new UserGetDTO(userId, "John",
                "Diamond", LocalDate.of(2000, 1, 1),
                "Mail@gmail.com", List.of(new CardGetDTO(1, userId, "1234567891018121",
                "JOHN DIAMOND", LocalDate.of(2027, 1, 1))));
        Order order = new Order(1, userId, OrderStatus.NEW, LocalDateTime.now(), List.of(orderItem1));
        ...
        when(userClient.getUserById(userId)).thenReturn(userGetDTO);
    ...
    void test_getOrdersByIds() {
        ...
        List<Order> orders = List.of(
                new Order(1, userId, OrderStatus.NEW, LocalDateTime.now(), List.of(orderItem1)),
                new Order(2, userId, OrderStatus.NEW, LocalDateTime.now(), List.of(orderItem2))
        );
    ...
    void test_createOrder() {
        ...
        when(jwtUtils.getAccessClaims(any())).thenReturn(userId);
    ...
    void test_getAllOrders() {
        ...
        Order order = new Order(1, userId, OrderStatus.NEW, LocalDateTime.now(), List.of());
        Page<Order> page = new PageImpl<>(List.of(order));
        UserGetDTO user = new UserGetDTO(userId, "Name", "Surname", LocalDate.of(1990,1,1), "email", List.of());
    ...
    void test_getOrderByStatus() {
        ...
        Order order = new Order(1, userId, OrderStatus.NEW, LocalDateTime.now(), List.of());
        Page<Order> page = new PageImpl<>(List.of(order));
        UserGetDTO user = new UserGetDTO(userId, "Name", "Surname",
    ...
    void test_update() {
        UUID userId = UUID.randomUUID();
        Integer id = 1;
        Order order = new Order(id, userId, OrderStatus.NEW, LocalDateTime.now(), List.of());
